import { ActionRowBuilder, ButtonBuilder, ButtonStyle, Interaction, ChannelType, PermissionFlagsBits, TextChannel } from "discord.js";
    ...
    if (customId.startsWith("help:")) {
      ...
      if (action === "home") {
        ...
        if (targetCmd === "tempvc" || targetCmd.startsWith("tempvc ")) {
          const { TEMPVC_DESCRIPTIONS, COMMAND_USAGES } = await import("../modules/configuration/commands/help.js");
          if (targetCmd === "tempvc") {
            const embed = new UniversalEmbed("neutral", undefined, interaction.guild!)
              .setTitle("🔊 tempvc")
              .setDescription(
